...
**Koku 酷 (コク) - Cruel, severe, harsh, terrible - 1596 of 2500**

\begin{tabular}{|m{6cm}|m{0.8cm}|m{1.4cm}|m{0.8cm}|m{6cm}|}
\hline
Right Radical & & Kanji & & Left Radical \\
\hline
(hiyominotori or sakezukuri) - "sake jar," "alcohol," or "wine. & \Huge 酉 & \scalebox{2}{\Huge 酷} & \Huge 告 & "to tell" or "to announce." Upper part is cow/ox (牛, the top variant ⺧), Lower is mouth (口) \\
\hline
\end{tabular}

Imagine a person who has consumed way too much alcohol from the **sake jar (酉)**. In their drunken state, they open their **mouth (口)** to loudly announce **(告) mean things** and yell at an innocent **cow (⺧)**. \hl{Drinking too much alcohol and screaming at people (or animals) is a terrible, cruel, and harsh way to behave.}

On\'yomi: コク (KOKU)

- 残酷 (ざんこく / zankoku) – cruelty, harshness (with 残, remains).
- 過酷 (かこく / kakoku) – severe, rigorous, harsh.
